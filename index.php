		...
		<div class="modal">
			<div class="modal-wrap">
				<form id="form" action="/amo/amo.php" method="post" onsubmit="javascript:return emailValidate();">
					...
					<div class="row">
						<input id="phone" name="phone" placeholder="+7 (000) 000-00-00" data-phone-pattern required /> </div>
					<div class="row">
						<label for="email">Введите Email для получения файлов:</label>
					</div>
					<div class="row">
						<input type="text" name="email" id="email" placeholder="E-mail" required /> </div>
					<input type="submit" value="Скачать файлы"> </form>
			</div>
		</div>
	</div>
</body>
